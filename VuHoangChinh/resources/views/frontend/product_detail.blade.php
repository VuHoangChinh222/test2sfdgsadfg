        ...
        <section class="py-5">
            <div class="container">
                <div class="row gx-5">
                    <aside class="col-lg-6">
                        <div class="border rounded-4 mb-3 d-flex justify-content-center">
                            <img style="maxWidth: 100%, maxHeight: 100vh, margin: auto" class="rounded-4 fit"
                                src="{{ asset('images/products/' . $productData->image) }}" alt="#" />
                        </div>
                        <div class="d-flex justify-content-center mb-3">
                            <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image"
                                href="#">
                                <img width="60" height="60" class="rounded-2"
                                    src="{{ asset('images/products/' . $productData->image) }}" />
                            </a>
                            <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image"
                                href="#">
                                <img width="60" height="60" class="rounded-2"
                    ...
                    <main class="col-lg-6">
                        <div class="ps-lg-3">
                            <h4 class="title text-dark">{{ $productData->name }}</h4>
                            ...
                            <div class="mb-3">
                                <span
                                    class="h5">${{ $productData->pricesale ? $productData->pricesale : $productData->price }}</span>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4 col-6 mb-3">
                                    ...
                                    <div class="input-group mb-3" style="width: 170px,height:35px">
                                        <input type="number" class="form-control text-center border border-secondary"
                                            ...
                                            aria-describedby="button-addon1" min="1" max="10" id="qty" />
                                    </div>
                                </div>
                            </div>
                            <button href="#" class="btn btn-warning shadow-0 me-1"> Buy now </button>
                            <button class="btn btn-primary shadow-0 me-1" onclick="handleAddCart({{ $productData->id }})">
                                <i class="me-1 fa fa-shopping-basket"></i> Add
                                to cart </button>
                        </div>
                    </main>
                </div>
                        ...
                        <div class="px-0 border rounded-2 shadow-0">
                            <div class="card1">
                                <div class="card1-body">
                                    <h5 class="card1-title">Similar items</h5>
                                    @foreach ($list_product as $item)
                                        <x-similar-item-product :item='$item' />
                                    @endforeach
                                </div>
                            </div>
                        </div>
